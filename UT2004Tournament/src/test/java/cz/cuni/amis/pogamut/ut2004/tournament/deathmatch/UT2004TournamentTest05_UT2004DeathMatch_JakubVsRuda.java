 ...
 * @author Jimmy
 */
public class UT2004TournamentTest05_UT2004DeathMatch_JakubVsRuda {
	...
	public static UT2004DeathMatch createMatch() {
		return
			new UT2004DeathMatch1v1(
					...
					"DM-1on1-Albatross",
					"JakubBot",
					"bots" + File.separator + "KefikBot" + File.separator + "KefikBot.jar",
					"RudaBot",
					"bots" + File.separator + "PoJACTRHunter" + File.separator + "PoJACTRHunter.jar"
			).createMatch();
	}
