 ...
 * @author Jimmy
 */
public class UT2004TournamentTest18_UT2004DeathMatchRepeater_Kefik_v2vsNative {
	...
	private UT2004DeathMatchConfig configure1VsNative() {
		...
		matchConfig.setMatchId("KefikBot_v2-vs-NativeBot");
	...
	public void test() {
		...
		UT2004DeathMatchRepeater repeater = new UT2004DeathMatchRepeater(match, 100, new LogCategory("DMRepeater"));
