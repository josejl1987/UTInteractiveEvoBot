...
public class Copycat {
	 ...
	 */
	private static final Logger logger = Logger.getLogger(Copycat.class);
    ...
    public static void copyPopulation (final int generation, final Individual population []) {
        ...
        try {
			...
			logger.error("copyPopulation(int, Individual[])", e); //$NON-NLS-1$
        }
        ...
        for (int i = 0; i < population.length; ++i) {
            ...
            pw.print ("; SuperShieldsTaken = " + population [i].getNSuperShields());
            pw.print ("; ShieldsTaken = " + population [i].getNShields());
            pw.print ("; TotalTimeShock = " + population [i].getTotalTimeShock());
            pw.print ("; TotalTimeSniper = " + population [i].getTotalTimeSniper());
        ...
        try {
			...
			logger.error("copyPopulation(int, Individual[])", ex); //$NON-NLS-1$
