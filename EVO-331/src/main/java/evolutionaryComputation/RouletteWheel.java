...
public class RouletteWheel extends GeneticAlg {
	 ...
	 */
	private static final Logger logger = Logger.getLogger(RouletteWheel.class);
    ...
    public RouletteWheel (int GENERATIONS, int populationSize, CrossoverType crossoverType, Memoria memory) {
        ...
        for (int i = 0; i < population.length; ++i) {
            ...
            population [i] = new IndividualV1 (true, ProportionalFitness.class);
        }
    ...
    public void selection() {
        ...
        for (int i = 0; i <population.length; ++i) {
            ...
            if (generator.nextDouble() < 0.9) {
                ...
                newPopulation [i] = new IndividualV1 (false, ProportionalFitness.class);
