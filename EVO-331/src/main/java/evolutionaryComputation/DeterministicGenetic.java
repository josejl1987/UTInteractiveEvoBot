...
public class DeterministicGenetic extends GeneticAlg {
	 ...
	 */
	private static final Logger logger = Logger.getLogger(DeterministicGenetic.class);
    ...
    public void selection () {
        ...
        newPopulation [4] = new IndividualV1 (false, NonLinearFitness.class);
        ...
        newPopulation [5] = new IndividualV1 (false, NonLinearFitness.class);
        ...
        for (int individual = population.length - 7, nextOffspring = 6; individual > 3; --individual, ++nextOffspring) {
            ...
            newPopulation [nextOffspring] = new IndividualV1 (false, NonLinearFitness.class);
        ...
        newPopulation [newPopulation.length - 1] = new IndividualV1 (true, NonLinearFitness.class);
        newPopulation [newPopulation.length - 2] = new IndividualV1 (true, NonLinearFitness.class);
        newPopulation [newPopulation.length - 3] = new IndividualV1 (true, NonLinearFitness.class);
        newPopulation [newPopulation.length - 4] = new IndividualV1 (true, NonLinearFitness.class);
